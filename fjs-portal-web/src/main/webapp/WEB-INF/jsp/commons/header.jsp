  ...
  <div class="header_inner">
    <div class="logo">
		...
		<a name="sfbest_hp_hp_head_logo" href="http://www.e3mall.cn" class="trackref logoleft">
          <img src="/images/logo66.png" style="width: 200px;padding-left: 17px">
		</a>
		<div class="logo-text">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://localhost:8090/cart/cart.html" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
