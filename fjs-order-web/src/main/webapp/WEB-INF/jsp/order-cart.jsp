...
<div class="orderMain">
<form id="orderForm" class="" action="/order/create.html" method="post">
	...
	<input type="hidden" name="payment" value="<fmt:formatNumber value="${totalPrice / 100 + 10}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="false"/>"/>
	<input type="hidden" name="orderShipping.receiverName" value="阿超"/>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>阿超&nbsp;&nbsp;&nbsp;&nbsp;15800888888&nbsp;&nbsp;&nbsp;&nbsp;北京市&nbsp;&nbsp;昌平区&nbsp;&nbsp;北七家镇 修正大厦</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>覅甲蜀速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
